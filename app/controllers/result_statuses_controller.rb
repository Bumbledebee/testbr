class ResultStatusesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @result_status.save
        format.html { redirect_to @result_status, notice: 'Result status was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @result_status.update(result_status_params)
        format.html { redirect_to @result_status, notice: 'Result status was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to result_statuses_url, notice: 'Result status was successfully destroyed.' }
  ...
  private
    ...
    def result_status_params
      params.require(:result_status).permit(:name, :description)
    end
end
